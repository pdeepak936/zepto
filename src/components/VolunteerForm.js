...
//   return (
//     <div className="container mt containerborder center">
//       <h2 className="text-center mt-5">Volunteer Registration Form</h2>
...
//           <input type="text" className="form-control" id="contact" name="contact" onChange={handleChange} required />
//         </div>
//         <div className="form-group">
